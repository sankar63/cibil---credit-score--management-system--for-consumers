...
<div class="container mt-2 ">
  <div class="row d-flex justify-content-center ">
    <div class="col-md-7 bg-primary" style="color: black !important;">
      <div class="card p-3 py-4 bg-primary">
        <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
          ...
          <div class="text-center mt-2">
            ...
            <?php
              ...
              if(isset($_GET['id']));
              $id = $_GET['id'];
              $result = mysqli_query($connect, "select * from loanbk where id='$id'"); ?>
            ...
            $idd = $_POST['id'];
            $sql2 = mysqli_query($connect, "update loanbk set status='Approved' where id='$idd'");
        ...
        if (isset($_POST['rejected'])) {
            ...
            $sql41 = mysqli_query($connect, "update loanbk set status='Rejected' where id='$idd'");
