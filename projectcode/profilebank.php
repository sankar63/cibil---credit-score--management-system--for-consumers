              ...
              <a class="dropdown-item d-flex align-items-center" href="#">
                ...
                <div>
                  ...
                  <span class="font-weight-bold">
                    ...
                    if (isset($_POST['bttn'])) {
                      $result = mysqli_query($connect, "select * from loanbk");
                      while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                        if (($row['status'] == 'Approved') and ($row['username'] == $_SESSION['names']) and ($row['username'] == $_SESSION['names'])) {
                          echo 'Your Loan is Approved';

                        } else if (($row['status'] == 'rejected') and ($row['username'] == $_SESSION['names']) and ($row['username'] == $_SESSION['names'])) {
                          echo 'Your Loan is rejected';
                        } else if (($row['status'] == '') and ($row['username'] == $_SESSION['names']) and ($row['username'] == $_SESSION['names'])) {
          ...
          <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
            ...
            <div class="text-center mt-2">
              ...
              while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ...
                if (($_SESSION['pan'] == $row['pan_no']) and ($_SESSION['names'] == $row['username'])) { ?>
