                                    ...
                                    <span class="font-weight-bold">
                                        ...
                                        if (isset($_POST['bttn'])) {
                                            ...
                                            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                                if (($row['status'] == 'Approved') and ($row['username'] == $_SESSION['names3']) and ($row['username'] == $_SESSION['names3'])) {
                                                    echo 'Your Loan is Approved';

                                                } else if (($row['status'] == 'rejected') and ($row['username'] == $_SESSION['names3']) and ($row['username'] == $_SESSION['names3'])) {
                                                    echo 'Your Loan is rejected';
                                                } else if (($row['status'] == '') and ($row['username'] == $_SESSION['names3']) and ($row['username'] == $_SESSION['names3'])) {
                    ...
                    <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                        ...
                        <div class="text-center mt-2">
                            ...
                            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                ...
                                if (($_SESSION['pan3'] == $row['pan_no']) and ($_SESSION['names3'] == $row['username'])) { ?>
