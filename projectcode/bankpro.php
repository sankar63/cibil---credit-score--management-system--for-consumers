...
<div class="container">
            ...
            <div class="card-body">
             <h4 class="card-text">Bank User</h4>
               <img src="./IMG_20221115_223523-modified.png" class="card-img-top"alt="">
                 <h5 class="card-title mt1 text-capitalize">Name:<?php echo $row['username'];?></h5>
                <button class='btn btn-success'><a href="bankprofile.php?id=<?php echo $row['id']?>">Profile</a></button>
 ...
 <?php
  ...
  {
    $id= $_GET['id'];
    $select=mysqli_query($con,"select FROM `loanbk` WHERE `id`='$id'");
