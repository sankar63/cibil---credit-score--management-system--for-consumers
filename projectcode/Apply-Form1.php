...
<html lang="en">
  <head>
    ...
    <title>CIBIL SCORE Bank Loan Apply</title>
...
<link rel="stylesheet" href="../css/bootstrap-5.2.2-dist/bootstrap-5.2.2-dist/css/bootstrap.min.css">
  ...
  <body class="bg-info">
    ...
    <div class="container-fluid loan-bg ">
      <div class="container">
        <div class="row">
          <div id="news-slider" class="owl-carousel ">
            <div data-aos="fade-up" data-aos-duration="1000">
              <div class="post-slide">
                <div class="post-img">
                  <img src="../assets1/cibil-home-loan-rounded.jpg" alt="" style="height:270px ;" />
            ...
            <div data-aos="fade-up" data-aos-duration="1500">
              <div class="post-slide">
                <div class="post-img">
                  <img src="../assets1/cibil-medical loan courosel.jfif" alt="" style="height:270px ;" />
                  <a href="#" class="over-layer"><i class="fa fa-link"></i></a>
                </div>
                <div class="post-content">
            ...
            <div data-aos="fade-up" data-aos-duration="2000">
              <div class="post-slide">
                <div class="post-img">
                  <img src="../assets1/cibil-education page.png" alt="" style="height:270px ;" />
                  <a href="#" class="over-layer"><i class="fa fa-link"></i></a>
                </div>
                <div class="post-content">
        ...
        <div class="row">
          <div class="form-bg my-5" >
            ...
            <div class="col-md-12">
              ...
              <input type="number" name="p" id="PanNo" class="ps-2 ms-2 my-2 w-25 email-input"  required />
...
function click($n, $p1, $mn1, $a, $d, $m)
{
  ...
  $mon1 = ($a * ($d / 100) * $m);
   ...
   $insert = mysqli_query($connect, "INSERT INTO loanbk(username,pan_no,mobile_no,loan_id,loan_type,amount,percent,interest,duemonth,monthly,date_time) VALUES ('$n','$p1','$mn1','$loan_id','$lt','$a','$d','$mon','$mon1','$m','$date') ");
  if ($insert) {
    echo '<script> window.location.href="profilebank.php";
