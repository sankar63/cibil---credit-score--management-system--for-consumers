...
<head>
  ...
  <title>HCL Bank Loan Apply</title>
...
<body>
  <nav class="navbar navbar-expand-lg sticky-top bg-white">
    <div class="container-fluid">
      <a class="navbar-brand ms-5 me-1 w-25 d-flex " href="./index.php"><img src="../assets1/cibil-logo.png"
          alt="logo.svg" width="24%" />
        <span class=" h2 ps-2 pt-3 ">HCL</span>
  ...
  <div class="container-fluid bank-loan-bg-3 mb-5">
    <div class="container">
      <div class="row">
        <div id="news-slider" class="owl-carousel">
          <div data-aos="fade-up" data-aos-duration="1000">
            <div class="post-slide">
              <div class="post-img">
                <img src="../assets1/hcl-house loan courosel.webp" alt="" style="height:270px ;" />
          ...
          <div data-aos="fade-up" data-aos-duration="1500">
            <div class="post-slide">
              <div class="post-img">
                <img src="../assets1/medical loan carousel home-page.jpg" alt="" style="height:270px ;" />
                <a href="#" class="over-layer"><i class="fa fa-link"></i></a>
              </div>
              <div class="post-content">
          ...
          <div data-aos="fade-up" data-aos-duration="2000">
            <div class="post-slide">
              <div class="post-img">
                <img src="../assets1/hcl-education loan courosel.webp" alt="" style="height:270px ;" />
                <a href="#" class="over-layer"><i class="fa fa-link"></i></a>
              </div>
              <div class="post-content">
        ...
        <div class="col-lg-12">
          <div data-aos="flip-left" >
            <div class="home-loan-content-tittle">
              <h2 class="display-6">Get a quick loan </h2>
              <a href="#down" class="py-3 px-4 text-white apply-btn my-2">Apply now</a>
            </div>
          </div>
        </div>
      </div>
...
if (isset($_POST['btn'])) {
  click($_POST['name'], $_POST['p'], $_POST['m'], $_POST['amount'], $_POST['due'], $_POST['month']);
  $_SESSION['pan3'] = $_POST['p'];
  $_SESSION['names3'] = $_POST['name'];
}
function click($n, $p1, $mn1, $a, $d, $m)
{
  ...
  $mon = ($a * ($d / 100) * $m + $a);
  $mon1 = ($a * ($d / 100) * $m);
  $insert = mysqli_query($connect, "INSERT INTO loanbk3(username,pan_no,mobile_no,loan_id,loan_type,amount,penalty,interest,due_month,monthly,date_time) VALUES ('$n','$p1','$mn1','$loan_id','$lt','$a','$d','$mon','$mon1','$m','$date') ");
  if ($insert) {
    echo '<script> window.location.href="profilebank3.php";
