                        ...
                        <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
                            ...
                            <div class="text-center mt-2">
                                ...
                                if (isset($_GET['id']))
                                    ;
                                $id = $_GET['id'];
                                $result = mysqli_query($connect, "select * from loanbk3 where id='$id'"); ?>
                                ...
                                if (isset($_POST['approved'])) {
                                    $idd = $_POST['id'];
                                    $sql2 = mysqli_query($connect, "update loanbk3 set status='Approved' where id='$idd'");
                                ...
                                if (isset($_POST['rejected'])) {
                                    ...
                                    $sql41 = mysqli_query($connect, "update loanbk3 set status='Rejected' where id='$idd'");
